...
public class PdfView {
    ...
    public static void printToPdf(Activity activity, WebView webView, String directory, String fileName, final Callback callback) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            pdfPrint.print(webView.createPrintDocumentAdapter(jobName), directory, new PdfPrint.CallbackPrint() {
                @Override
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                pdfPrint.print(webView.createPrintDocumentAdapter(), directory, new PdfPrint.CallbackPrint() {
                    @Override
                    public void success(String path) {
                        callback.success(path);
                    }
